...
const undoTaskDelete = () => {
  ...
  return <div className="wrap">
    ...
    <section className={`phone${settingValues.compact ? ' compact-mode' : ''}${settingValues.motion ? '' : ' reduce-motion'}${query!==null?' searching':''}${restoringCachedSession?' session-restoring':''}`} inert={restoringCachedSession} aria-busy={restoringCachedSession}>
