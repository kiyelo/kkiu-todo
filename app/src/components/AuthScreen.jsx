...
import { getAuthRedirectUrl, getRestoredInitialSession, requireSupabase } from '../services/supabaseClient.js'
...
export default function AuthScreen({ pendingInvite = '' }) {
  ...
  // bootstrap session and this component renders normally on the next parent render.
  if (getRestoredInitialSession()) {
