...
export default function QueueScreen(props) {
  ...
  const reorderModel = useMemo(() => reorder ? buildModel(active, false, false, null, completedCount, true) : null, [active, completedCount, reorder])
