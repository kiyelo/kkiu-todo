...
export const tx = {
  ko: {
    ...
    authHero: '끼우 할 일을 가볍게 끼워 넣어요', authInviteSaved: code => `끼리 초대를 보관했어요 · ${code}`, authInviteAfterLogin: '로그인을 마치면 프로필 설정과 초대 확인 화면이 자동으로 열립니다.', authEmail: '이메일', authPassword: '비밀번호', authEmailLogin: '이메일로 로그인', authLoggingIn: '로그인 중…', authOr: '또는', authGoogle: 'Google 계정으로 로그인', authMoving: '이동 중…', authExpired: '로그인 링크가 만료됐거나 이미 사용됐어요. 다시 시도해주세요.', authFailed: '로그인에 실패했어요.', authMissingCredentials: '이메일과 비밀번호를 모두 입력해주세요.', authProblem: '로그인 중 문제가 생겼어요.',
  },
  en: {
    ...
    authHero: 'Slip your to-dos into place with Kkiu', authInviteSaved: code => `Circle invite saved · ${code}`, authInviteAfterLogin: 'After signing in, profile setup and the invite confirmation will open automatically.', authEmail: 'Email', authPassword: 'Password', authEmailLogin: 'Sign in with email', authLoggingIn: 'Signing in…', authOr: 'or', authGoogle: 'Sign in with Google', authMoving: 'Opening…', authExpired: 'This sign-in link has expired or was already used. Please try again.', authFailed: 'Sign-in failed.', authMissingCredentials: 'Enter both your email and password.', authProblem: 'Something went wrong while signing in.',
  },
}
