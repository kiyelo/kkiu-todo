...
export const tx = {
  ko: {
    ...
    insert: n => `${n}번째에 할 일 끼우기`, placeholder: '할 일을 입력하고 끼우기', empty: '할 일이 없어요', searchPlaceholder: '검색어', searchEmpty: '무엇을 찾을까요?', searchHint: '찾고 싶은 할 일을 입력하세요', noSearch: '결과가 없어요', done: n => `완료됨 ${n}개 보기`,
