...
const checks = [
  ...
  ['More keeps qvp-owned scrolling', moreScreen.includes('more-queue-stage') && moreScreen.includes('ref={queue.scrollerRef}') && moreScreen.includes('{...queue.scrollProps}') && queue.includes("!stage.classList.contains('more-queue-stage')") && nativeComposerScroll.includes(':not(.more-queue-stage)')],
