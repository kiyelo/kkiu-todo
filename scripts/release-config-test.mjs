...
check('Android app theme uses one guarded AppCompat controller', androidThemePlugin.includes('AppCompatDelegate.setDefaultNightMode(requestedMode)') && androidThemePlugin.includes('AppCompatDelegate.getDefaultNightMode() != requestedMode') && androidThemePlugin.includes('MODE_NIGHT_FOLLOW_SYSTEM') && !androidThemePlugin.includes('setApplicationNightMode'))
...
check('System theme refresh never writes native night mode', themePlatform.includes('const refreshThemePreference') && themePlatform.includes('void refreshThemePreference(preference)') && themePlatform.includes('void applyThemePreference(preference)') && androidThemePlugin.includes('manager.getNightMode()'))
